...
//import java.util.Arrays; //For some questionable alternatives down below
...
public class RandNumbersTask {
    ...
    public static void run () {
        ...
        if(verticalArrangement) {
            ...
            System.out.println();
//            Discovering System.out.print later than lists ans such, sigh...
//            Integer[] line = new Integer[quantity];
//            for (int i = 0; i < quantity; i++) {
//                line[i] = ThreadLocalRandom.current().nextInt(0,10_001);
//            }
